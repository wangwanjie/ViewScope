...
enum ViewScopeInterfaceLanguage: String {
    ...
    private static let table: [ViewScopeInterfaceLanguage: [String: String]] = [
        .english: [
            ...
            "server.error.unsupported_mutation": "This property cannot be edited live.",
            "server.error.invalid_mutation_value": "The requested value is invalid for this property.",
            ...
            "server.item.x": "X",
            "server.item.y": "Y",
            "server.item.width": "Width",
            "server.item.height": "Height",
        ...
        .simplifiedChinese: [
            ...
            "server.error.unsupported_mutation": "这个属性暂不支持实时修改。",
            "server.error.invalid_mutation_value": "请求的新值不适用于这个属性。",
            ...
            "server.item.x": "X",
            "server.item.y": "Y",
            "server.item.width": "宽度",
            "server.item.height": "高度",
        ...
        .traditionalChinese: [
            ...
            "server.error.unsupported_mutation": "這個屬性暫不支援即時修改。",
            "server.error.invalid_mutation_value": "要求的新值不適用於這個屬性。",
