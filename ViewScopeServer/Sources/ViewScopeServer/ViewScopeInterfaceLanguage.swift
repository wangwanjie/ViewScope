...
enum ViewScopeInterfaceLanguage: String {
    ...
    private static let table: [ViewScopeInterfaceLanguage: [String: String]] = [
        .english: [
            ...
            "server.item.button_state": "Button State",
            "server.item.placeholder": "Placeholder",
            "server.item.corner_radius": "Corner Radius",
            "server.item.border_width": "Border Width",
            "server.item.value": "Value",
            "server.item.identifier": "Identifier",
            "server.item.tooltip": "Tool Tip",
            "server.item.view_controller": "View Controller",
            "server.item.target": "Target",
            "server.item.action": "Action",
            ...
            "server.value.first_responder": "First Responder",
        ...
        .simplifiedChinese: [
            ...
            "server.item.button_state": "按钮状态",
            "server.item.placeholder": "占位文本",
            "server.item.corner_radius": "圆角半径",
            "server.item.border_width": "边框宽度",
            "server.item.value": "值",
            "server.item.identifier": "标识符",
            "server.item.tooltip": "提示文本",
            "server.item.view_controller": "视图控制器",
            "server.item.target": "Target",
            "server.item.action": "Action",
        ...
        .traditionalChinese: [
            ...
            "server.item.button_state": "按鈕狀態",
            "server.item.placeholder": "預留文字",
            "server.item.corner_radius": "圓角半徑",
            "server.item.border_width": "邊框寬度",
            "server.item.value": "值",
            "server.item.identifier": "識別碼",
            "server.item.tooltip": "提示文字",
            "server.item.view_controller": "視圖控制器",
            "server.item.target": "Target",
            "server.item.action": "Action",
