...
drawText("UI Inspector", rect: NSRect(x: leftPanel.minX, y: leftPanel.midY - 14, width: leftPanel.width, height: 24), font: .monospacedSystemFont(ofSize: 13, weight: .medium), color: subtitleColor)
drawText("Shortcut", rect: NSRect(x: rightPanel.minX, y: rightPanel.midY - 38, width: rightPanel.width, height: 24), font: .monospacedSystemFont(ofSize: 13, weight: .medium), color: subtitleColor)
